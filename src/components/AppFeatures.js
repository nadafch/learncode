  ...
  return (
    <div className="features">
      <section className="features__coding" style={{ backgroundColor: '#1266F1' }}>
        <h2 className='mb-3' data-aos="fade-down"
          data-aos-easing="linear"
          data-aos-duration="1500"><strong>Belajar menyesuaikan dengan minat mu.</strong></h2>
        <p className='mb-4' data-aos="fade-up"
          data-aos-duration="3000">dan masih banyak lagi...</p>
        <div className="features__languages">
          <img src={html} alt="html logo" data-aos="flip-left"
            data-aos-easing="ease-out-cubic"
            data-aos-duration="2000" />
          <img src={css} alt="css logo" data-aos="flip-left"
            data-aos-easing="ease-out-cubic"
            data-aos-duration="2000" />
          <img src={js} alt="js logo" data-aos="flip-left"
            data-aos-easing="ease-out-cubic"
            data-aos-duration="2000" />
          <img src={react} alt="react logo" data-aos="flip-left"
            data-aos-easing="ease-out-cubic"
            data-aos-duration="2000" />
          <img src={git} alt="git logo" data-aos="flip-left"
            data-aos-easing="ease-out-cubic"
            data-aos-duration="2000" />
          <img src={nodejs} alt="nodejs logo" data-aos="flip-left"
            data-aos-easing="ease-out-cubic"
            data-aos-duration="2000" />
        </div>
      </section>
        ...
        <div className="features__list">
          <div className="features__item">
            <img src={fitur1} alt="feature 1"
              ...
              data-aos-delay="300"
              data-aos-offset="0" />
            <div className="features__itemDesc" data-aos="fade-left">
          ...
          <div className="features__item">
            <img src={fitur2} alt="feature 2"
              ...
              data-aos-easing="ease-out-cubic"
              data-aos-duration="2000" />
            <div className="features__itemDesc" data-aos="fade-right">
