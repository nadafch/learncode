    ...
    return (
        <div>
            <Navbar bg="light">
                <Container>
                    <Navbar.Brand>
                        <img src={LearnCode} alt="Logo" height={23} />
                    </Navbar.Brand>
                    <Nav>
                        {localStorage.getItem("token") == "adaTokenNih" ? (
                            <React.Fragment>
                                <Nav.Link to="/Dashboard">All Course</Nav.Link>
                                <Button variant="outline-primary" onClick={(e) => handlerAction("logout")}>
                                    Logout
                                </Button>
                            </React.Fragment>
                        ) : (
                            <React.Fragment>
                                ...
                                <Button variant="outline-primary" onClick={(e) => handlerAction("login")}>
                                    Login
                                </Button>
                            </React.Fragment>
                        )}
