          ...
          <CDBBox display="flex" justifyContent="between" className="flex-wrap">
            <CDBBox>
              ...
              <p className="my-3" style={{ width: "250px" }}>
                We are a PlatForm that provides free learning through materials
                and video references that we recommend.
              </p>
            ...
            <CDBBox>
              <p
                className="h5 mb-4"
                style={{ fontWeight: "600", color: "#4154F1" }}
              >
                Explore
              </p>
              <div
              ...
              >
                <a className="td text-dark mb-1" href="/">
                  Home
                </a>
                <a className="td text-dark mb-1" href="/">
                  Courses
