    ...
    <React.Fragment>
      {
        tentang.map((value, index) => (
          <div className='content-card' data-aos="flip-left" data-aos-duration="500">
            <Card>
              ...
              <div className='social-media'>
                ...
                <MDBBtn className='m-1' style={{ backgroundColor: '#ac2bac' }} href={value.instagram}>
                  <MDBIcon fab icon='instagram' />
                </MDBBtn>

                <MDBBtn className='m-1' style={{ backgroundColor: '#0082ca' }} href={value.linkedin}>
                  <MDBIcon fab icon='linkedin-in' />
                </MDBBtn>

                <MDBBtn className='m-1' style={{ backgroundColor: '#25d366' }} href={value.WhatsApp}>
